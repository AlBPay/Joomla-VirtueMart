...
class plgVmPaymentFondy extends vmPSPlugin
{
    ...
    function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $html = '	<form action="' . Fondy::URL . '" method="post" id="fondy_payment_form">
            ...
            '</form>' .
            "<div><img src='https://example.com/img/loader.gif' width='50px' style='margin:20px 20px;'></div>".
    ...
    function plgVmOnPaymentNotification() {
        ...
        $orderitems['comments'] = 'Alliance bank ID: '.$order_id. " Ref ID : ". $_POST['payment_id'];
